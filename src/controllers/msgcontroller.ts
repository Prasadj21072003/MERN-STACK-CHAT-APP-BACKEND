...
export const makegroup = async (req: Request, res: Response) => {
  try {
...
export const sendgroupmsg = async (req: Request, res: Response) => {
  try {
...
export const getgroupmsg = async (req: Request, res: Response) => {
  try {
...
export const clearallmsg = async (req: Request, res: Response) => {
  try {
